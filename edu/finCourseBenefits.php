...
if($prmOk){
	...
	<div class='subTitle'>$yearLabel: $year &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;نوع الدورة: $CrstpDescription</div>
	<table class='topTable'>
		<tr><td colspan='3' style='width:15cm;'>البرنامج: $CrsName</td><td style='width:3cm;'>رقم: $CoursBulletin</td><td>$crsHoursLabel $crsHours</td></tr>
		<tr><td style='width:9cm;'>المنطقة: $dist_name </td><td colspan='3' style='width:9cm;'>$datesLabel من:$CoursFromAct  الى:$CoursToAct</td><td>الساعات المنفذة: $totActHours</td></tr>
	...
	<table class='signatureTable'>
		<tr><td>رئيس وحدة الاستحقاقات</td><td>مدير إدارة الموارد البشرية</td><td>رئيس قسم المراجعة</td><td>مدير ادارة الشئون المالية</td></tr>
