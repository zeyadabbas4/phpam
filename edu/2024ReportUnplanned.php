...
<head>
    <meta charset="UTF-8" />
    <title>الدورات غير المخططة من  1-4 وحتى 30-6-2024</title>
    <style>
        * {
...
$result=array();
$i=0;
$q="SELECT CoursId,CoursBulletin,CrsName,CoursFromAct,CoursToAct,CrstpDescription,cmpName FROM Courses INNER JOIN CoursesGuide ON CoursCrsId=CrsId INNER JOIN CourseTypes ON CoursType=CrstpId INNER JOIN conCourses ON CoursId=concrsId INNER JOIN companies ON concrsCmp=cmpId WHERE CoursFromAct>='2024-04-1' AND CoursFromAct<='2024-06-30' AND CoursType=2 ORDER BY CoursType,CoursFromAct;";
if ($stmt = mysqli_prepare($dbc, $q)){
        if(mysqli_stmt_execute($stmt)){
            if(mysqli_stmt_bind_result($stmt,$CoursId,$CoursBulletin,$CrsName,$CoursFromAct,$CoursToAct,$CrstpDescription,$cmpName)){
                    ...
                    $result[$i]['CrstpDescription']=$CrstpDescription;
    ...
    <table class='headTable'>
        <tr>
            ...
            <td>
                ...
                <h3>الدورات غير المخططة من  1-4 وحتى 30-6-2024</h3>            
            </td>
