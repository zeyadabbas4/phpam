...
$noFields=3;
$fieldNames[0]="PrgId";
$fieldNames[1]="PrgCode";
$fieldNames[2]="PrgName";
...
$fieldLabels[0]="رقم البرنامج";
$fieldLabels[1]="كود البرنامج";
$fieldLabels[2]="اسم البرنامج";
...
$insertFields=array(1,2);                   
$updateFields=array(1,2);
$masterKey=array(0);
$listFields=array(2);                         //fields in the list
$orderList=true;                                  //user order clause
$listOrderFields=array(2);                        //fiels in order clause
...
$showKeyInAdd=false;
$addFormLabel="جديد";
$addFormFields=array(1,2);
$editFormLabel="تعديل";
$editFormFields=array(1,2);
$saveLabel="حفظ";
$cancelLabel="تراجع";
$okLabel="حسنا";
$showAddButton=true;
