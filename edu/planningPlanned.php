...
if(isset($_SESSION['__uid'])){
  ...
  if($logged){
    ...
    $pageSubTitle="مراجعة بيانات الدورات المخططه";
...
//************************************************************************************ */    
    if($mode=='view' ){
      ...
      echo "<button type='submit' name='mode' value='agreeConfirm' class='yesBtn' style='width: 150px;$hide'>ارسال للموارد البشرية</button> "; 
      echo "<button type='submit' name='mode' value='rejectConfirm' class='noBtn' style='width: 150px;$hide'>رد ﻹدارة التعليم</button> ";  
...
/*********************************************************************************************************** */
    if($showList){
      ...
      if($r){
        ...
        echo "<th>المنشور - اسم الدورة</th><th style='width:250px;text-align: center;'></th></tr>";
        $rowNo=0;
