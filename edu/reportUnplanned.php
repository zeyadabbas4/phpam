...
<head>
    <meta charset="UTF-8" />
    <title>تقرير الدورات غير المخططة</title>
    <style>
        * {
...
if(isset($mode)){
            ...
            <table class='headTable'>
                <tr>
                    ...
                    <td>
                        ...
                        <h3>تقرير الدورات غير المخططة من $datefrom وحتى $dateto</h3>            
                    </td>
    ...
    <h2>معهد تدريب الموانئ</h2>
    <h2>إدارة التعليم والتدريب</h2>
    <h3>تقرير الدورات غير المخططة</h3>
