...
if(isset($_SESSION['__uid'])){
  ...
  if($logged){
    ...
    $pageSubTitle="الاستحقاقات - إعتماد نتيجة دورات المحاكي";
...
//************************************************************************************ */    
    if($mode=='view' ){
      ...
      echo "<button type='submit' name='mode' value='rejectConfirm' class='noBtn' style='width: 200px;$hide'>غير موافق</button> ";  
