...
if(isset($_SESSION['__uid'])){
  ...
  if($logged){
    ...
    $YearId=$user_year['Id'];
    $pageTitle="متابعة الدورات لعام $trnYear - دورات المحاكي";
