...
<head>
    <meta charset="UTF-8" />
    <title>الدورات الحتمية من  31-5 وحتى 30-6-2024</title>
    <style>
        * {
...
$result=array();
$i=0;
$q="SELECT CoursId,CoursBulletin,CrsName,CoursFromAct,CoursToAct FROM Courses INNER JOIN CoursesGuide ON CoursCrsId=CrsId WHERE CoursFromAct>='2024-04-1' AND CoursFromAct<='2024-06-30' AND CoursType=4 ORDER BY CoursType,CoursFromAct;";
if ($stmt = mysqli_prepare($dbc, $q)){
        if(mysqli_stmt_execute($stmt)){
            if(mysqli_stmt_bind_result($stmt,$CoursId,$CoursBulletin,$CrsName,$CoursFromAct,$CoursToAct)){
    ...
    <table class='headTable'>
        <tr>
            ...
            <td>
                ...
                <h3>الدورات الحتمية من  1-4 وحتى 30-6-2024</h3>            
            </td>
